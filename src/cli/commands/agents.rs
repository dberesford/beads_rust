...
fn execute_check(
    ...
    let file_path = detection
        .file_path
        .as_ref()
        .expect("found() implies file_path is set");
    let file_type = detection
        .file_type
        .as_ref()
        .expect("found() implies file_type is set");
...
fn execute_remove(
    ...
    let file_path = detection
        .file_path
        .as_ref()
        .expect("has_blurb implies file_path is set");
    let content = detection
        .content
        .as_ref()
        .expect("has_blurb implies content is set");
...
fn execute_update(
    ...
    let file_path = detection
        .file_path
        .as_ref()
        .expect("blurb check implies file_path is set");
    let content = detection
        .content
        .as_ref()
        .expect("blurb check implies content is set");
